...
public class GuiOxidizer extends GuiContainer
{
	private static final ResourceLocation texture = new ResourceLocation("chemi","textures/gui/oxidizer.png");

	TileEntityOxidizer tile;

	public GuiOxidizer(InventoryPlayer p,TileEntityOxidizer tileOxidizer)
	{
		super(new ContainerOxidizer(p,tileOxidizer));
		tile = tileOxidizer;
	}

	protected void drawGuiContainerForegroundLayer(int p_146979_1_, int p_146979_2_)
    {
		String s = StatCollector.translateToLocal("container.oxidizer");
